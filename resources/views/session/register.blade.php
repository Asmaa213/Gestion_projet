...
@section('content')
  ...
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('../assets/img/Great teamwork.jpeg');">
          ...
          <div class="card z-index-0">
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Phone" name="phone" id="phone" aria-label="Phone" aria-describedby="phone-addon">
                  @error('phone')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Function" name="function" id="function" aria-label="Function" aria-describedby="function-addon">
                  @error('function')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                ...
                <div class="mb-3">
                  <input type="file" accept="image/jpg, image/jpeg, image/png" required class="form-control" name="image" >
                  @error('image')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
